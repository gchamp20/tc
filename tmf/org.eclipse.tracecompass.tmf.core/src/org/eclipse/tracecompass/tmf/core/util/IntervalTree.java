 ...
 * @since 4.2
 */
public class IntervalTree<T extends IHTInterval> {
    ...
    protected void find(List<T> results, long point) {
        ...
        if (point > getStart()) {
            ...
            if (fLeft != null) {
                /*
                 * FIXME: Eclipse gives potential null access error unless this double check is there.
                 * Event if fLeft != null is before fLeft.getUpperBound() ...
                 */
                if (fLeft.getUpperBound() >= point && fLeft != null) {

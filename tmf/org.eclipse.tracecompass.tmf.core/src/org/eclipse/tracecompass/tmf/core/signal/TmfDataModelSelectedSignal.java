...
public class TmfDataModelSelectedSignal extends TmfSignal {
    ...
    private final Multimap<@NonNull String, @NonNull String> fMetadata;
     ...
     */
    public TmfDataModelSelectedSignal(Object source, Multimap<@NonNull String, @NonNull String> metadata) {
        super(source);
        fMetadata = metadata;
    }
